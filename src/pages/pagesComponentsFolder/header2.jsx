...
import images from './Images/imagessss.jpeg'
...
function Header2() {
   ...
   const {userName}=useContext(OpenModalContext)
 ...
 const handlelifeInsuranceClicked=()=>{
  navigate('https://prime.rw/life-insurance/about-life-insurance/about-us')
 }
     ...
     useEffect(() => {
      ...
      if (!token) {
        ...
        if (decodedToken.exp < currentTime) {
          if(isCurrent) setIsTokenActive(false); 
          // console.log('Token inactive'+"token will expire in"+" ",decodedToken.exp+" "+"current time is",currentTime);
        } else {
          if(isCurrent) setIsTokenActive(true);
     ...
     return (
      <div className="container  mx-auto lg:mx-0">
       <div className="  md:hidden  h-8  ">
         <div className="  ">
            <div onClick={()=>{setOpenTopDrawer(true);}}  className=" absolute right-3">
                <img style={{height:48}} src={images} alt="" />
            </div>
            <div  onClick={() => navigate(-1)} className=" absolute left-3 w-16 top-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="" height="58.7" viewBox="0 0 182.6 133.3">
    <path fill="#FFF" d="M60.4 11.8L33 117.7h74.7l29.6-36.2 17.6-62-28.6-14.3z"/>
    <path fill="#F8D209" d="M182.6 0H47.4L0 133.3h135.1L182.6 0zM43.3 111.6l32-86.4H99l-32 86.4H43.3zM97 86.4l22.6-61.2h23.7l-22.6 61.2H97z"/>
</svg>
        ...
        <div>
          ...
          >
           <div className="   ml-16 z-30 text-black">{nameToUse}</div>  
          ...
          >
            {({ TransitionProps, placement }) => (
              ...
              >
                <Paper className=" z-30 text-white w-full bg-black  max-sm:mt-14  max-sm: ml-5">
                  <ClickAwayListener onClickAway={handleClose}>
                    ...
                    >
                      ...
                      <MenuItem onClick={handleClose}>My policies</MenuItem>
        ...
        {
            isSmallScreen&&( <TemporaryDrawer openTopDrawer={openTopDrawer} setOpenTopDrawer={setOpenTopDrawer}></TemporaryDrawer>)
        }
        
         
        </div>
        <div className="   w-auto max-sm:hidden ">
       
       <div className=" flex  justify-normal       max-sm:px-6 max-sm:overflow-hidden">
        ...
        <Link to="https://prime.rw/life-insurance/about-life-insurance/about-us"> <button    style={{fontStyle:"normal", fontFamily: 'Open Sans, sans-serif',fontWeight:200,fontSize:20}} className=" text-dropdownTextColor family">
          ...
          <div>
           ...
           <div>
           <div className="flex items-center"> {/* Use 'items-center' to vertically center children */}
         ...
         <Link to="https://prime.rw/careers"> <button  style={{fontStyle:"normal", fontFamily: 'Open Sans, sans-serif',fontWeight:200,fontSize:20}} className=" text-dropdownTextColor family">
           ...
           {
            token&& istokenIsActive?(<div className="   items-center">{<Stack direction="row" spacing={2}>
           ...
           <div className="  ">
             <Button
               ...
               onClick={handleToggle}
             >
             <Typography className="  flex" variant="h6"> <div className=" mr-8 mt-2"> {nameToUse}</div> <div className=" absolute right-0  top-0  "><RiArrowDropDownLine size={50} /></div></Typography>
         ...
         </Stack>}</div>):( <div className="  max-sm:ml-4   items-center" style={{ whiteSpace: "nowrap" }}> {/* Use 'items-center' to vertically center children */}
           <div  className=" flex items-center ">
           <button style={{backgroundColor:'blue'}} onClick={()=>{navigate('/login');setLoginFromHeader(true)}} type="button" class="text-white    hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm  px-10 py-2 text-center me-2 mb-2">Login</button>
